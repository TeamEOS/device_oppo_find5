...
# Board Info
TARGET_GLOBAL_CFLAGS += -DQCOM_HARDWARE -DDISABLE_HW_ID_MATCH_CHECK
TARGET_GLOBAL_CPPFLAGS += -DQCOM_HARDWARE -DDISABLE_HW_ID_MATCH_CHECK
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/oppo/find5/bluetoot
